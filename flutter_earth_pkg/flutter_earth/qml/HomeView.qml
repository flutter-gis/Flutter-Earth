...
Rectangle {
    ...
    ColumnLayout {
        ...
        Text {
            ...
            font.pixelSize: ThemeProvider.getFont("title").pixelSize + 8 // Make it larger than standard title
        ...
        Text {
            ...
            font.bold: true // Make status bold
        ...
        RowLayout {
            ...
            Repeater {
                ...
                delegate: Button {
                    ...
                    contentItem: Text {
                        text: parent.text
                        font: parent.font // Use button's font
