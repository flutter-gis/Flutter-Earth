...
class AdvancedGISManager(QObject):
    ...
    def _initialize_default_state(self):
        ...
        default_panels = [
            ...
            PanelState(PanelType.TOOLBOX, True, True, "left", (250, 300)),
            PanelState(PanelType.SEARCH, True, True, "top", (400, 50)),
            PanelState(PanelType.BOOKMARKS, False, True, "right", (250, 300)),
            PanelState(PanelType.ATTRIBUTE_TABLE, False, True, "bottom", (600, 200)),
            PanelState(PanelType.COORDINATE_DISPLAY, True, True, "bottom", (200, 30)),
            PanelState(PanelType.SCALE_BAR, True, True, "bottom", (150, 30)),
        ...
        default_layout = WorkspaceLayout(
            ...
            panels=[asdict(p) for p in default_panels],
            map_views=[asdict(v) for v in default_map_views],
            active_tab="main"
        )
        ...
        try:
            ...
            if layouts_file.exists():
                ...
                for layout_data in data.get("layouts", []):
                    layout = WorkspaceLayout(**layout_data)
