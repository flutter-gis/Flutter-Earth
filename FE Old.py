...
# The following block is commented out to prevent uninstalling/reinstalling libraries on start
...
def build_mosaic(sensor_name, target_year, target_month, roi_geometry, tile_log_index, cancel_processing_event):
    ...
    # Or, as originally: 15th of prev month to 15th of next month. This is a ~2 month window.
    ...
    for attempt_num in range(max_retries + 1): # +1 for initial attempt
        ...
        except EEException as gee_error:
